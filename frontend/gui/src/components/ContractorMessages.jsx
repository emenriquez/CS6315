...
class ContractorMessages extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ready: false,
  ...
  componentDidUpdate() {
    if (!this.state.ready) {
      if (this.props.token) {
        ...
        axios
          .get(`http://127.0.0.1:8000/contractormsg/${query}`, options)
          .then((res) => {
            console.log(res);
...
export default connect(mapStateToProps, mapDispatchToProps)(ContractorMessages);
